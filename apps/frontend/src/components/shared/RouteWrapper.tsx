...
import { RefreshCw, Home, Mail, type LucideIcon } from 'lucide-react';
...
export function RouteWrapper({ children, icon, title, description, reloadPath }: RouteWrapperProps) {
  return (
    <ErrorBoundary
