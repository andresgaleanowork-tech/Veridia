...
export function Step1PatientData({ patients, selectedPatientId, onPatientSelect, state, onChange, onNext }: Step1Props) {
  ...
  }, [watched.peso, watched.altura, watched.edad, watched.sexo, watched.formula, watched.fa, watched.fe, watched.ajuste, watched.patKey, watched.medicacion, watched.alergias, onChange, state.selectedPaths]);
