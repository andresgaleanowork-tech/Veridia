...
const inputCls = 'w-full px-3 py-2.5 bg-white/5 border border-white/10 rounded-xl text-sm text-text placeholder:text-text-3 focus:outline-none focus:border-[#0891B2] focus:ring-1 focus:ring-[#0891B2]/30 transition-all';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="bg-surface-2 border border-border rounded-xl px-3 py-2 text-text text-sm focus:outline-none focus:border-[#0891B2]"
          />
        </div>
        {totalCalories > 0 && (
                ...
                <div className="px-4 pb-4 border-t border-white/5 space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="bg-surface-2 border border-border rounded-xl px-3 py-1.5 text-text text-sm focus:outline-none focus:border-[#0891B2]"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2 bg-surface-2 border border-border rounded-xl text-text text-sm placeholder:text-text-3 focus:outline-none focus:border-[#0891B2]"
                    />
                  </div>
        ...
        <Card>
          ...
          <div className="px-6 pb-4 flex items-center gap-3">
            ...
            <input
              ...
              className="w-20 text-center bg-surface-2 border border-border rounded-xl py-1.5 text-text focus:outline-none focus:border-[#0891B2]"
            />
