...
function SettingsPageFallback({ error, requestId, resetError, isDev, navigate, copyErrorDetails, reportError }: FallbackProps) {
    ...
    >
      ...
      >
        ...
        <p className="text-text-3 text-sm mb-6 text-center">
          No se pudo cargar la configuración. Intenta recargar o contacta a soporte.
        </p>
...
export function SettingsPageWrapper() {
  return (
    <ErrorBoundary
      fallbackRender={(props) => <SettingsPageFallback {...props} />}
    >
      <SettingsPage />
    </ErrorBoundary>
  );
